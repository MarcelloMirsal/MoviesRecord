...
class MovieImagesLayout {
    ...
    func imagesLayout() -> UICollectionViewCompositionalLayout {
        let headerItem = NSCollectionLayoutItem(layoutSize: .init(widthDimension: .fractionalWidth(1), heightDimension: .fractionalWidth(9/21)))
        ...
        let mainGroup = NSCollectionLayoutGroup.vertical(layoutSize: .init(widthDimension: .fractionalWidth(1), heightDimension: .estimated(200)), subitems: [headerItem, doubleGroup, tripleRowGroup])
